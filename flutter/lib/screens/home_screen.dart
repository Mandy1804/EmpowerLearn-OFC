...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _carregarNome() async {
    ...
    setState(() {
      nome = nomeSalvo;
      inicial = nomeSalvo.trim().isNotEmpty
  ...
  Widget build(BuildContext context) {
    final primeiroNome = nome.trim().isEmpty
        ? 'Aluno'
        : nome.trim().split(RegExp(r'\s+')).first;
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: const LinearGradient(
                          colors: [Color(0xFF1F2A63), Color(0xFF241A52)],
                        ),
                      ),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: const LinearGradient(
                                colors: [Color(0xFF4F7BFF), Color(0xFF7B4DFF)],
                              ),
                            ),
                            child: const Icon(
                              Icons.trending_up,
